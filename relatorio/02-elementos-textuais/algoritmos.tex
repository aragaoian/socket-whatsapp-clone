...
critério do algoritmo do Valentão também é aplicado na inicialização, sem depender
...
A eleição segue o algoritmo do Valentão, descrito resumidamente na Figura \ref{fig:fluxo-eleicao}. Seu passo a passo na implementação é:
